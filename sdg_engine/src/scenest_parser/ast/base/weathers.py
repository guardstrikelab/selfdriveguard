...
from src.scenest_parser.ast.base.state import Node, Variable,NodeType
...
class WeatherContinuousIndex(Variable,Node):
	def __init__(self,index:float,name:Optional[AnyStr]=None):
...
class WeatherDiscreteLevel(Variable,Node):
	def __init__(self,level:WeatherDiscreteLevelEnum,name:Optional[AnyStr]=None):
		Variable.__init__(self,name)
