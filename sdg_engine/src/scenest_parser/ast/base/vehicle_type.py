...
from src.scenest_parser.ast.base.state import Node, NodeType, Variable
...
class SpecificType(Type):
	def __init__(self,value:AnyStr,name:Optional[AnyStr]=None):
		super().__init__(name)
		self._value=value
...
class GeneralType(Type):
	def __init__(self,type_enum:GeneralTypeEnum,name:Optional[AnyStr]=None):
		super().__init__(name)
...
class Material:
	pass# TODO:Currently,we do not consider material
...
class ColorList(Color):
	def __init__(self,colorListEnum:ColorListEnum,name:Optional[AnyStr]=None):
		super().__init__(name)
...
class RGBColor(Color):
	def __init__(self,r:int,g:int,b:int,name:Optional[AnyStr]=None):
		super().__init__(name)
