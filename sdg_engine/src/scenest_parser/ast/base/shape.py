...
class Shape(Variable,Node):
	...
	def calculate_volume(self):
		pass
class Sphere(Shape):
	def __init__(self,radius:float,name:Optional[AnyStr]=None):
		super().__init__(name)
		self._radius=radius
	...
	def calculate_volume(self):
		pass
class Box(Shape):
	def __init__(self,length:float,width:float,height:float,name:Optional[AnyStr]=None):
		super().__init__(name)
	...
	def calculate_volume(self):
		pass
class Cone(Shape):
	def __init__(self,radius:float,height:float,name:Optional[AnyStr]=None):
		super().__init__(name)
