...
from src.scenest_parser.ast.base.state import Node, State,Variable,NodeType
...
class Motion(Variable):
	def __init__(self,motion:Union[UniformMotion,WaypointMotion],name:Optional[AnyStr]=None):
		super().__init__(name)
		self._motion=motion
