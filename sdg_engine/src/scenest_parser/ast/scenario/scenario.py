...
from src.scenest_parser.ast.base.state import *
from src.scenest_parser.ast.map.map import *
from src.scenest_parser.ast.ego.ego_vehicle import *
from src.scenest_parser.ast.npc.npc_vehicles import *
from src.scenest_parser.ast.pedestrian.pedestrians import *
from src.scenest_parser.ast.obstacle.obstacles import *
from src.scenest_parser.ast.environment.environment import *
from src.scenest_parser.ast.traffic.traffic import *
from typing import Optional,AnyStr,NoReturn
class Scenario(Variable,Node):
    def __init__(self,name=Optional[AnyStr]):
