...
from src.scenest_parser.ast.base.state import Variable,State,Node,NodeType
from src.scenest_parser.ast.base.motion import VehicleMotion
from src.scenest_parser.ast.base.vehicle_type import VehicleType
...
class NPCVehicle(Variable,Node):
    ...
    def set_second_state(self,second:State)->NoReturn:
        self._second=second
    def setVehicleMotion(self,motion:VehicleMotion)->NoReturn:
        self._motion=motion
