<template>
    <div class="product-list" v-loading="loading">
        <div class="list-top">
            <span class="page-title">属</span>
            <el-input placeholder="按属名或科名查询" v-model="filter.query" class="input-with-select" clearable
        ...
        <div class="list-bottom">
            <el-pagination background @current-change="fetchList" v-model:current-page="page.currentPage"
                           :page-size="20" layout="total, prev, pager, next, jumper" :total="page.totalCount">
            </el-pagination>
        </div>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            ...
            fetchList() {
                ...
                this.$axios({
                    method: "get",
                    url: this.$basePath + "/mushroom/genus",
                    params: {
                        pageSize: 20,
