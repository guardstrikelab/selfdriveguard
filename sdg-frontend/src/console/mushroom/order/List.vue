<template>
    <div class="product-list" v-loading="loading">
        <div class="list-top">
            <span class="page-title">目</span>
            <el-input placeholder="按目名或纲名查询" v-model="filter.query" class="input-with-select" clearable
        ...
        <div class="list-bottom">
            <el-pagination background @current-change="fetchList" v-model:current-page="page.currentPage"
                           :page-size="40" layout="total, prev, pager, next" :total="page.totalCount">
            </el-pagination>
        </div>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            ...
            fetchList() {
                ...
                this.$axios({
                    method: "get",
                    url: this.$basePath + "/mushroom/order",
                    params: {
                        pageSize: 40,
